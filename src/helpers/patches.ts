...
const indices = new Array(numTeapotPatches);
...
export const diviteCurve = (points: Array<Array<number>>) => {
  ...
  const p12center = mix(p1, p2, 0.5);

  l[2] = mix(l[1], p12center, 0.5);
  r[1] = mix(r[2], p12center, 0.5);
...
export const teaPotVertex = indices;
